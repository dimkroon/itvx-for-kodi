...
def all_categories():
    ...
    query = 'query GetAllCategories { genres(filter: { hubCategory: true }) { id name } }'
    return _gql_query(query)
...
def category_az(cat):
    ...
    return _gql_query(cat_az_query, variables)