...
CHANNELS = {
    'ITV': {'id': 'viwx.itv',
            'name': 'ITV',
            'logo': 'https://images.ctfassets.net/bd5zurrrnk1g/54OefyIkbiHPMJUYApbuUX/7dfe2176762fd8ec10f77cd61a318b07/itv1.png',
            'preset': 1},
    'ITV2': {'id': 'viwx.itv2',
             'name': 'ITV2',
             'logo': 'https://images.ctfassets.net/bd5zurrrnk1g/aV9MOsYOMEXHx3iw0p4tk/57b35173231c4290ff199ef8573367ad/itv2.png',
             'preset': 2},
    'ITVBe': {'id': 'viwx.itvbe',
              'name': 'ITVBe',
              'logo': 'https://images.ctfassets.net/bd5zurrrnk1g/6Mul5JVrb06pRu8bNDgIAe/b5309fa32322cc3db398d25e523e2b2e/itvBe.png',
              'preset': 3},
    'ITV3': {'id': 'viwx.itv3',
             'name': 'ITV3',
             'logo': 'https://images.ctfassets.net/bd5zurrrnk1g/39fJAu9LbUJptatyAs8HkL/80ac6eb141104854b209da946ae7a02f/itv3.png',
             'preset': 4},
    'ITV4': {'id': 'viwx.itv4',
             'name': 'ITV4',
             'logo': 'https://images.ctfassets.net/bd5zurrrnk1g/6Dv76O9mtWd6m7DzIavtsf/b3d491289679b8030eae7b4a7db58f2d/itv4.png',
             'preset': 5}
}
