...
class WatchProgress(unittest.TestCase):
    """Progress is the watch status of episodes of a particulat programme. Only available for
    ...
    def test_progress_by_resume(self):
        ...
        This would be interseting becuase Resume returns the playing time as well as progress.
